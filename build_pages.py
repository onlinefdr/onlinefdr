...
MARQUEE_ITEMS = """
      ...
      <span class="marquee-item">Australian Mediation Association <span class="marquee-sep">&bull;</span></span>
      <span class="marquee-item">Section 60I Certificates Nationally <span class="marquee-sep">&bull;</span></span>
      <span class="marquee-item">Online via Google Meet <span class="marquee-sep">&bull;</span></span>
    ...
    <div class="wrap">
      ...
      <div class="faq-list reveal">
        <div class="faq-item">
          ...
          <div class="faq-a"><p>For parenting orders, yes. Under section 60I of the Family Law Act, FDR is the step the law expects to be taken before applying for parenting orders, unless an exemption applies. For property and financial matters, courts expect parties to have made a genuine attempt at resolution first, although there is no equivalent certificate requirement.</p></div>
        </div>
        <div class="faq-item">
    ...
    <div class="article-grid">
      <article class="article-body">
        ...
        <div class="factor-rows">
          ...
          <div class="factor-row"><div class="factor-num"><span>5</span></div><div class="factor-content"><h4>Benefit of meaningful relationships with parents and significant others</h4><p>The benefit of relationships with both parents and significant others, where it is safe to do so. Since May 2024, the presumption of equal shared parental responsibility no longer applies, and this factor does not have elevated status relative to other considerations.</p></div></div>
  ...
  <div class="wrap article-wrap">
    <div class="article-grid">
      <article class="article-body">
        ...
        <p>The court can order sole ownership to one party, transfer to a third party with consent, or sale. The court considers caregiving history, the financial cost of providing for the animal, any history of family violence or animal abuse, and the relationship between the animal and any children. The court cannot order shared ownership or shared care of a companion animal.</p>
  ...
  <section class="page-faq" aria-labelledby="s60i-faq-heading">
    <div class="wrap">
      ...
      <div class="faq-list reveal" style="max-width:760px">
        ...
        <div class="faq-item"><button class="faq-q" aria-expanded="false">Is a Section 60I certificate required for financial matters?<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button><div class="faq-a"><p>No. Section 60I applies specifically to applications for parenting orders under Part VII of the Family Law Act. It does not apply to property or financial matters. However, courts do expect parties to have made a genuine attempt at resolution before commencing property proceedings, and a failure to do so without good reason can affect costs. FDR is available and strongly recommended for financial matters, but there is no equivalent certificate requirement.</p></div></div>
      ...
      <div class="timeline">
        ...
        <div class="tl-item reveal">
          ...
          <div class="tl-content">
            ...
            <p>If agreement is not reached, parties can request a <a href="/section-60i/">Section 60I certificate</a>, which documents what occurred in the process. The certificate type reflects the practitioner's professional assessment of what happened, including whether each party attended and whether each made a genuine effort. A certificate is the outcome of last resort, not the goal of the process.</p>
            <div class="tl-meta">
              <span class="tl-tag tl-tag-terra">Goal: agreement</span>
              <span class="tl-tag tl-tag-note">Section 60I certificate if needed</span>
            </div>
          </div>
        </div>
    ...
    <div class="wrap">
      <div class="article-grid">
        <article class="article-body reveal">
          ...
          <p>The Section 60I requirement is specific to parenting matters. For property and financial settlement, there is no identical certificate requirement, though courts expect parties to have made a genuine attempt at resolution before commencing proceedings. FDR for financial matters is available, widely used, and strongly recommended.</p>
  ...
  },
  {
    ...
    "items": [
      ...
      ("Do I need a Section 60I certificate before applying for parenting orders?",
       "Yes, in most cases. Before applying for parenting orders in the Federal Circuit and Family Court, you must attempt FDR with an accredited FDRP and obtain a Section 60I certificate. The court will not accept the application in most circumstances without one. Exemptions exist for matters involving family violence, child abuse, or urgent situations requiring immediate court intervention."),
  ...
  },
  {
    ...
    "items": [
      ...
      ("Do I need a Section 60I certificate for financial settlement?",
       "No. Section 60I certificates are required before applying for parenting orders in the Federal Circuit and Family Court. There is no equivalent certificate requirement for financial and property matters. Courts do, however, expect parties to have made a genuine attempt at resolution before commencing financial proceedings. FDR for financial matters is widely used and strongly recommended. The same accredited FDRP can facilitate FDR across both parenting and financial matters in the same engagement, with the same statutory confidentiality and inadmissibility protections under sections 10H and 10J of the Family Law Act applying to both."),
  ...
  <div class="wrap legal-wrap">
    <div class="legal-grid">
      ...
      <article class="legal-body">
        ...
        <p><strong>Section 60I certificates.</strong> Section 60I certificates are issued at the practitioner's professional discretion. Where a certificate is issued, the type of certificate (i.e. which paragraph of section 60I(8) of the Family Law Act applies) is determined by the practitioner's assessment of what occurred in the FDR process, including whether each party made a genuine effort and whether FDR was appropriate in the circumstances. The certificate type is not negotiable. Parties cannot request a particular type of certificate. The practitioner's assessment is made in accordance with the practitioner's professional and statutory obligations under the Family Law (Family Dispute Resolution Practitioners) Regulations 2025.</p>
